## Analyse the relationship between foundation species vs. abundance and diversity using codispersion analysis
...
#save.image("Results_18-12-09.RData")
#load("Results_18-12-09.RData")
